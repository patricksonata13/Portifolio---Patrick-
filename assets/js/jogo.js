...
function processarJogo(cmd) {
    ...
    p.style.cssText = "margin:8px 0; border-left:2px solid #ffae00; padding-left:8px; color:#fff; font-family:monospace;";
...
// Função para iniciar o alerta sem travar o site
...
// Teclado restrito apenas ao campo de input do jogo
